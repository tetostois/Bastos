...
let MailService = class MailService {
    configService;
    transporter;
    templatesDir = path.join(process.cwd(), 'src', 'common', 'mail', 'templates');
    templates = new Map();
    ...
    async sendValidationEmail(email, name, validationLink) {
    ...
    async sendExaminerCredentials(email, name, tempPassword, loginLink) {
        return this.sendMail({
            to: email,
